...
import com.example.spinnertutorial.databinding.SizesFragBinding
import com.example.spinnertutorial.lists.Lists

class SizesFrag : Fragment() {
    private var _binding: SizesFragBinding? = null
    private val binding get() = _binding!!
    lateinit var radioGroup: RadioGroup


    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        _binding = SizesFragBinding.inflate(inflater, container, false)
        radioGroup = binding.radioGroup

        createRadioButtons()

      //  val position: FragmentInterface = activity as FragmentInterface
        val size: FragmentInterface = activity as FragmentInterface
        ...
        radioGroup.setOnCheckedChangeListener { group, checkedId ->
            ...
            size.transferSize(radioButton.text.toString())
    ...
    private fun createRadioButtons() {
        ...
        val buttonsList: List<String> = Lists.sampleSizes
