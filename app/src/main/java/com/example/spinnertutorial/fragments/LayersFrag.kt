...
class LayersFrag : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        val layer: FragmentInterface = activity as FragmentInterface
        ...
        radioGroup.setOnCheckedChangeListener { group, checkedId ->
            ...
            layer.transferLayer(radioButton.text.toString())
    ...
    private fun createRadioButtons() {
        ...
        val buttonsList: List<String> = Lists.additionalLayers
